...
There will be computers available in the workshop location. If you wish to learn to use R on your own laptop, please make sure you have the latest version of R downloaded (3.6.0) and at least a moderately recent RStudio (1.1.463 or greater). The room we will be meeting in (London Road Campus, L33 120) is not the most ergonomic arrangement, so please make sure to have each day's files downloaded to the computer you are using so that you can follow along without needing to crane your neck!
