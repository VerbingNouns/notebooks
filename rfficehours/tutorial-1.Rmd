...
Now, going back to our dataset, if we want to view the content of one column, such as ``,
...
query how many items are in the first experiment only, we could do so by specifying a subset
